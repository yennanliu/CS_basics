...
# V1
# https://github.com/OmkarPathak/Data-Structures-using-Python/blob/master/Stack/Stack.py
class Stack(object):
    def __init__(self, limit = 10):
        self.stack = []
        self.limit = limit
...
#     for i in range(10):
#         myStack.push(i)
#     print(myStack)          # show all elements in the Stack  (method 1 )
#     myStack.pop()           # popping the top element
#     print(myStack)
#     myStack.peek()          # printing the top element
#     myStack.isEmpty()
#     myStack.size() 
#     myStack.__str__()       # show all elements in the Stack  (method 2 )
