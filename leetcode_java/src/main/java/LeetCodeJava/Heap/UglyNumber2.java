...
//    }
    ...
    /** IDEA:
     *
     *  We know every ugly number is generated by
     *  multiplying a smaller ugly number by either 2, 3, or 5.
     *
     * So:
     * 	1.	Start with 1 in a min-heap.
     * 	2.	Repeatedly pop the smallest number (the next ugly number).
     * 	3.	Multiply it by 2, 3, and 5 and push the results back into the heap.
     * 	4.	Use a Set to avoid duplicates.
     * 	5.	The number popped on the n-th time is the n-th ugly number.
     *
     *
     * 	-> KEY !!! we simply loop from 1 to n,
