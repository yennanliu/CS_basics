...
359| [Logger Rate Limiter](https://leetcode.com/problems/logger-rate-limiter/) | [Python](./leetcode_python/Design/logger_rate_lmiter.py.py), [Java](./leetcode_java/src/main/java/LeetCodeJava/HashTable/LoggerRateLimiter.java) | _O(1), amortized_ | _O(k)_ | Easy |🔒, google| OK |
