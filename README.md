...
084| [Largest Rectangle in Histogram](https://leetcode.com/problems/largest-rectangle-in-histogram/)     |[Python](./leetcode_python/Greedy/largest-rectangle-in-histogram.py)  | _O(n)_ | _O(1)_| Hard|top 100 like, 2 pointers, brute force, divide and conquer, stack, amazon, fb| AGAIN (not start)
