...
133| [Clone Graph](https://leetcode.com/problems/clone-graph/)| [Python](./leetcode_python/Breadth-First-Search/clone-graph.py) | _O(n)_ | _O(n)_  | Medium  |good trick, `check #138 Copy List with Random Pointer `,`graph`,`dfs`,`bfs`, copy, `UBER`, `google`,`amazon`,`fb`|  AGAIN************* (8)
...
734| [Sentence Similarity](https://leetcode.com/problems/sentence-similarity/) | [Python ](./leetcode_python/Depth-First-Search/sentence-similarity.py) | _O(n + p)_ | _O(p)_| Easy |good basic, graph, `hash table`,`collections.defaultdict(set)` ,`google`| OK*** (3)
737| [Sentence Similarity II](https://leetcode.com/problems/sentence-similarity-ii/solution/) | [Python](./leetcode_python/Depth-First-Search/sentence-similarity-ii.py) | _O(m * n)_  | _O(m * n)_  | Medium |dfs, union find, `google`| not start
