...
238 | [Product of Array Except Self](https://leetcode.com/problems/product-of-array-except-self/) | [Python](./leetcode_python/Array/product-of-array-except-self.py)  | _O(n)_ | _O(1)_ | Medium  | LintCode, `good trick`, `Apple`, `M$`, `amazon`, `fb`| OK******* (but again)(4)
...
496| [Next Greater Element I](https://leetcode.com/problems/next-greater-element-i/) |  [python](./leetcode_python/Stack/next_greater_element_i.py) | _O(n)_| _O(n)_| Easy|stack, LC 739, LC 503, LC 406| AGAIN*** (1) (not start)
503| [Next Greater Element II](https://leetcode.com/problems/next-greater-element-ii/) | [python](./leetcode_python/Stack/next_greater_element_ii.py) | _O(n)_| _O(n)_| Medium|LC 739, LC 503, LC 406|  AGAIN*** (1) (not start)
...
739| [Daily Temperatures](https://leetcode.com/problems/daily-temperatures/) | [python](./leetcode_python/Stack/daily-temperatures.py)  | _O(n)_  | _O(n)_ | Medium |LC 739, LC 503, LC 406, AGAIN, stack, good trick,`amazon`| AGAIN****** (4) 
...
226| [Invert Binary Tree](https://leetcode.com/problems/invert-binary-tree/) |  [python](./leetcode_python/Tree/invert-binary-tree.py) | _O(n)_ | _O(h)_, _O(w)_ | Easy |good basic| OK**** (2) (but again) 
...
100| [Same Tree](https://leetcode.com/problems/same-tree/)  |[Python](./leetcode_python/Recursion/same-tree.py) | _O(n)_ | _O(h)_| Easy|recursion, dfs, bfs, `good basic`,`amazon`| OK****** (3) (but again)
...
449|[Serialize and Deserialize BST](https://leetcode.com/problems/serialize-and-deserialize-bst/)| [python](./leetcode_python/Binary_Search_Tree/serialize-and-deserialize-bst.py) | _O(n)_ | _O(h)_ | Medium |`trick`,`serizlize deserizlize`,`BST`, tree,check #297, `amazon`, `fb`| AGAIN*********** (6)
...
|-----|---------------- | --------------- | --------------- | --------------- | ------------- |--------------|-----|
102| [Binary Tree Level Order Traversal](https://leetcode.com/problems/binary-tree-level-order-traversal/)| [Python](./leetcode_python/Breadth-First-Search/binary-tree-level-order-traversal.py)| _O(n)_| _O(n)_| Easy  |`GOOD basic`, `dfs`, `bfs`,`UBER`, `apple`,`amazon`,`fb`|  AGAIN******* (6) (must)
