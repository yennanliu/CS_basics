...
240 | [Search a 2D Matrix II](https://leetcode.com/problems/search-a-2d-matrix-ii/) |  [Python](./leetcode_python/Array/search-a-2d-matrix-ii.py)  | _O(m + n)_ | _O(1)_ | Medium   | EPI, LintCode, `basic`, `matrix`, `trick`, `binary search`, check `# 74 Search a 2D Matrix`, `amazon`, `apple`| OK***** (5) (but again)
...
003| [Longest Substring Without Repeating Characters](https://leetcode.com/problems/longest-substring-without-repeating-characters/) | [Python ](./leetcode_python/Hash_table/longest-substring-without-repeating-characters.py)  | _O(n)_ | _O(1)_ | Medium |`good trick`, `hash table`,`apple`,`amazon`,`fb`| AGAIN********* (5) (but AGAIN)
...
438| [Find All Anagrams in a String](https://leetcode.com/problems/find-all-anagrams-in-a-string/) | [Python ](./leetcode_python/Hash_table/find-all-anagrams-in-a-string.py) | _O(n)_ | _O(1)_ | Medium |`trick`, `AGAIN`, `sliding window`,`acc Counter`,`amazon`,`fb`| AGAIN************** (7)
...
523| [Continuous Subarray Sum](https://leetcode.com/problems/continuous-subarray-sum/) | [Python ](./leetcode_python/Hash_table/continuous-subarray-sum.py) | _O(n)_  | _O(k)_ | Medium |check `# 560 Subarray Sum Equals K`,`good trick`,`substring`, `hash table`,`AGAIN`,`M$`,`fb`| AGAIN************ (6)
...
|  #  | Title           |  Solution       |  Time           | Space           | Difficulty    | Note          | Status| 
|-----|---------------- | --------------- | --------------- | --------------- | ------------- |--------------|-----|
002| [Add Two Numbers](https://leetcode.com/problems/add-two-numbers/) | [Python](./leetcode_python/Linked_list/add-two-numbers.py) | _O(n)_   | _O(1)_  | Medium | check `# 445 Add Two Numbers II`, `basic`, `linked list`, `airbnb`, `amazon`, `fb`| OK**** (4) (but again)  
...
206| [Reverse Linked List](https://leetcode.com/problems/reverse-linked-list/)| [Python](./leetcode_python/Linked_list/reverse-linked-list.py) | _O(n)_  | _O(1)_ | Easy  |`good basic`,`amazon`,`fb`| OK********* (7) (but AGAIN)
...
725 | [Split Linked List in Parts](https://leetcode.com/problems/split-linked-list-in-parts/) | [Python](./leetcode_python/Linked_list/split-linked-list-in-parts.py)  | _O(n + k)_ | _O(1)_ | Medium |linked list, good trick,`amazon`| AGAIN****** (3) (again)
...
|  #  | Title           |  Solution       |  Time           | Space           | Difficulty    | Note | Status | 
|-----|---------------- | --------------- | --------------- | --------------- | ------------- |--------------|-----|
020| [Valid Parentheses](https://leetcode.com/problems/valid-parentheses/)| [Python](./leetcode_python/Stack/valid-parentheses.py) | _O(n)_ | _O(n)_ | Easy |`good basic`,`fb`, `amazon`| OK** (4) 
...
538 | [Convert BST to Greater Tree](https://leetcode.com/problems/convert-bst-to-greater-tree/) |  [python](./leetcode_python/Tree/convert-bst-to-greater-tree.py) | _O(n)_ | _O(h)_ | Medium |good basic, dfs, bfs, tree, `amazon`| OK****** (4) (but again!) 
...
545 | [Boundary of Binary Tree](https://leetcode.com/problems/boundary-of-binary-tree/) | [python](./leetcode_python/Tree/boundary-of-binary-tree.py) | _O(n)_ | _O(h)_ | Medium    |dfs, tree boundary, tree,🔒, `good trick`, `amazon`| AGAIN***** (4) 
...
142| [Linked List Cycle II](https://leetcode.com/problems/linked-list-cycle-ii/)| [Python](./leetcode_python/Two_Pointers/linked-list-cycle-ii.py) | _O(n)_ | _O(1)_   | Medium   |linked list, 2 pointers, check #141| AGAIN*** (3) (again!)
...
167| [Two Sum II - Input array is sorted](https://leetcode.com/problems/two-sum-ii-input-array-is-sorted/) |  [Python](./leetcode_python/Two_Pointers/two-sum-ii-input-array-is-sorted.py) | _O(n)_   | _O(1)_ | Easy | two pointer, dict, binary search,`good basic`, `amazon`| OK*  (5)
...
098| [Validate Binary Search Tree](https://leetcode.com/problems/validate-binary-search-tree/)|[Python](./leetcode_python/Recursion/validate-binary-search-tree.py)| _O(n)_ | _O(1)_ | Medium |recursion, bfs, dfs,`BST`,`M$`,`amazon`, `fb`| AGAIN************ (7) 
...
105| [Construct Binary Tree from Preorder and Inorder Traversal](https://leetcode.com/problems/construct-binary-tree-from-preorder-and-inorder-traversal/) | [Python](./leetcode_python/Recursion/construct-binary-tree-from-preorder-and-inorder-traversal.py) | _O(n)_ | _O(n)_ | Medium  |`trick`, check # 106,`BST`,`M$`, `fb`| AGAIN******* (5)
106| [Construct Binary Tree from Inorder and Postorder Traversal](https://leetcode.com/problems/construct-binary-tree-from-inorder-and-postorder-traversal/) | [Python](./leetcode_python/Recursion/construct-binary-tree-from-inorder-and-postorder-traversal.py) | _O(n)_  | _O(n)_  | Medium  |`trick`,check # 105,`BST`,`M$`, `fb`|  AGAIN******* (5)
...
162| [Find Peak Element](https://leetcode.com/problems/find-peak-element/) |  [Python](./leetcode_python/Binary_Search/find-peak-element.py)| _O(logn)_  | _O(1)_  | Medium |good trick, binary search,`M$`, `google`, `fb`| AGAIN****** (4)
...
235 | [Lowest Common Ancestor of a Binary Search Tree](https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-search-tree/) |  [python](./leetcode_python/Binary_Search_Tree/lowest-common-ancestor-of-a-binary-search-tree.py) | _O(h)_ | _O(1)_ | Easy |BST, recursion, iteration, good basic, `LCA`, check `# 236 Lowest Common Ancestor of a Binary Tree`, `amazon`,`fb`| OK******* (but again)(6) 
...
449|[Serialize and Deserialize BST](https://leetcode.com/problems/serialize-and-deserialize-bst/)| [python](./leetcode_python/Binary_Search_Tree/serialize-and-deserialize-bst.py) | _O(n)_ | _O(h)_ | Medium |good trick,`serizlize deserizlize`,`BST`, tree,check #297, `amazon`, `fb`| AGAIN*********** (7)
...
776|[Split BST](https://leetcode.com/problems/split-bst/)| [python](./leetcode_python/Binary_Search_Tree/split-bst.py) | _O(n)_ | _O(h)_ | Medium | 🔒, BST, tree, DFS, trick, basic, AGAIN ,`amazon` | AGAIN****** (4) (not start***)
...
127| [Word Ladder](https://leetcode.com/problems/word-ladder/)| [Python](./leetcode_python/Breadth-First-Search/word-ladder.py) | _O(n * d)_   | _O(d)_ | Hard/Medium |check #126 Word Ladder II, `bfs`,`good trick`,  `UBER`, `amazon`, `M$`, `fb`| AGAIN********** (7)
...
200| [Number of Islands](https://leetcode.com/problems/number-of-islands/) | [Python](./leetcode_python/Depth-First-Search/number-of-islands.py) | _O(m * n)_ | _O(m * n)_| Medium |`bfs`, `dfs`,`good basic`,check `# 694, 711 Number of Distinct Islands`,`apple`, `Goldman Sachs`,`google`,`amazon`,`fb`| OK****** (5)
236 | [Lowest Common Ancestor of a Binary Tree](https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-tree/) | [Python](./leetcode_python/Depth-First-Search/lowest-common-ancestor-of-a-binary-tree.py) | _O(n)_ | _O(h)_ | Medium | `trick`,EPI, `LCA`,check `235 Lowest Common Ancestor of a Binary Search Tree`,`apple`,`amazon`,`linkedin`,`fb` | AGAIN*********** (7)
...
|  #  | Title           |  Solution       |  Time           | Space           | Difficulty    | Tag, Note       | Status| 
|-----|---------------- | --------------- | --------------- | --------------- | ------------- |--------------|-----|
017| [Letter Combinations of a Phone Number](https://leetcode.com/problems/letter-combinations-of-a-phone-number/)| [Python](./leetcode_python/Backtracking/letter-combinations-of-a-phone-number.py)  | _O(n * 4^n)_ | _O(n)_ | Medium |dfs, backtrack, `good trick`,`UBER`, `amazon`, `google`, `fb`| AGAIN************* (6) (again !)
...
039| [Combination Sum](https://leetcode.com/problems/combination-sum/)| [Python](./leetcode_python/Backtracking/combination-sum.py) | _O(k * n^k)_ | _O(k)_ | Medium |backtrack,`dfs`,`good basic`,`UBER`, `airbnb`, `amazon`,`fb`| OK****** (5) (but again)
040| [Combination Sum II](https://leetcode.com/problems/combination-sum-ii/)| [Python](./leetcode_python/Backtracking/combination-sum-ii.py) | _O(k * C(n, k))_| _O(k)_| Medium| similar as `#39  Combination Sum`| AGAIN*** (2) (again)
...
079| [Word Search](https://leetcode.com/problems/word-search/) |  [Python](./leetcode_python/Backtracking/word-search.py)  | _O(m * n * l)_ | _O(l)_ | Medium    |back tracking,`good trick`,`dfs`,`bloomberg`, `M$`, `amazon`,`fb`| AGAIN********** (5) (again!) 
...
078| [Subsets](https://leetcode.com/problems/subsets/) | [Python](./leetcode_python/Backtracking/subsets.py) | _O(n * 2^n)_   | _O(1)_| Medium  |`good concept` , similar as, dfs, back track`#90 Subsets II `, `UBER`, `amazon`, `fb`| AGAIN******* (4) (again!)
...
435 | [Non-overlapping Intervals](https://leetcode.com/problems/non-overlapping-intervals/) | [Python](./leetcode_python/Greedy/non-overlapping-intervals.py)  | _O(nlogn)_ | _O(1)_ | Medium | good trick, 2 pointers, inverval, similiar as `#452 Minimum Number of Arrows to Burst Balloons`, Line Sweep, `google` |  AGAIN***** (4)
...
0380| [Insert Delete GetRandom O(1)](https://leetcode.com/problems/insert-delete-getrandom-o1/) | [Python](./leetcode_python/Design/insert_delete_get_random_O_1.py) | _O(1)_ | _O(n)_| Medium/Hard |set, list, dict, `amazon`,`fb`| OK* (4)
...
0178| [Rank Scores](https://leetcode.com/problems/rank-scores/) | [MySQL](./leetcode_SQL/rank-scores.sql) | _O(n^2)_| _O(n)_| Medium |`trick`, `SQL var`,  ank, select same table, rank| AGAIN****** (6)
...
0534| [Game Play Analysis III](https://leetcode.com/problems/game-play-analysis-iii/) | [MySQL](./leetcode_SQL/game-play-analysis-iii.sql) | _O(nlogn)_ | _O(n)_  | Medium |🔒, `SQL var`, `tricky`, window func| AGAIN***** (5)
0550| [Game Play Analysis IV](https://leetcode.com/problems/game-play-analysis-iv/) | [MySQL](./leetcode_SQL/game-play-analysis-iv.sql) | _O(n)_ | _O(n)_| Medium|`tricky`, good basic, where min condition | OK******* (5) (but again)
...
1132| [Reported Posts II](https://leetcode.com/problems/reported-posts-ii/) | [MySQL](./leetcode_SQL/reported-posts-ii.sql)  | _O(m + n)_ | _O(n)_ | Medium   |🔒| OK*** (3)
...
1241| [Number of Comments per Post](https://leetcode.com/problems/number-of-comments-per-post/) | [MySQL](./leetcode_SQL/number-of-comments-per-post.sql) | _O(n)_ | _O(n)_| Easy |🔒, good basic| OK** (3)
1251| [Average Selling Price](https://leetcode.com/problems/average-selling-price/) | [MySQL](./leetcode_SQL/average-selling-price.sql) | _O(n)_ | _O(n)_| Easy|🔒, good basic| OK*** (but again) (2)
...
1412| [Find the Quiet Students in All Exams](https://leetcode.com/problems/find-the-quiet-students-in-all-exams/) | [MySQL](./leetcode_SQL/find-the-quiet-students-in-all-exams.sql) | _O(m + nlogn)_ | _O(m + n)_| Hard|🔒, good trick, not in, inner join on multiple cols| OK**** (2) (but again)
...
1555| [Bank Account Summary](https://leetcode.com/problems/bank-account-summary/) | [MySQL](./leetcode_SQL/bank-account-summary.sql) | _O(m + n)_ | _O(m + n)_| Medium|🔒, union all, good trick| OK**** (1)(but again)
...
1581| [Customer Who Visited but Did Not Make Any Transactions](https://leetcode.com/problems/customer-who-visited-but-did-not-make-any-transactions/) | [MySQL](./leetcode_SQL/customer-who-visited-but-did-not-make-any-transactions.sql) | _O(n)_ | _O(n)_| Easy|🔒, left join, good basic| OK** (1)(but again)
...
1596| [The Most Frequently Ordered Products for Each Customer](https://leetcode.com/problems/the-most-frequently-ordered-products-for-each-customer/) | [MySQL](./leetcode_SQL/the-most-frequently-ordered-products-for-each-customer.sql) | _O(n)_ | _O(n)_| Medium|🔒, good trick, `rank() ORDER BY count`| OK** (1)(again)
...
1613| [Find the Missing IDs](https://leetcode.com/problems/find-the-missing-ids/) | [MySQL](./leetcode_SQL/find-the-missing-ids.sql) | _O(n^2)_ | _O(n)_| Medium|🔒, `RECURSIVE CTE`, good trick| AGAIN*** (1)
