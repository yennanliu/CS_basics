...
572 |[Subtree of Another Tree](https://leetcode.com/problems/subtree-of-another-tree/)| [python](./leetcode_python/Tree/subtree-of-another-tree.py) | _O(m * n)_ | _O(h)_ | Easy, tree,good basic, dfs, bfs |`amazon`,`fb`| AGAIN*********** (4)
