...
224| [Basic Calculator](https://leetcode.com/problems/basic-calculator/) |[python](./leetcode_python/Stack/basic-calculator.py)| _O(n)_| _O(n)_| Hard |`basic`,`trick`,`stack`, check LC 227| AGAIN (not start)
227| [Basic Calculator II](https://leetcode.com/problems/basic-calculator-ii/) |[python](./leetcode_python/Stack/basic-calculator-ii.py)| _O(n)_| _O(n)_| Medium |check LC 224, `basic`,`trick`,`stack`,`airbnb` ,`fb`| AGAIN********** (4)
...
969| [Pancake Sorting](https://leetcode.com/problems/pancake-sorting/) | [Python](./leetcode_python/Sort/pancake-sorting.py) | _O(n^2)_ | _O(l)_  | Medium |`fb`, sorting| AGAIN** (2) (not start)
...
621 | [Task Scheduler](https://leetcode.com/problems/task-scheduler/) | [Python](./leetcode_python/Greedy/task-scheduler.py)  | _O(n)_ | _O(1)_ | Medium |`trick`,`array`,`greedy`, `fb`, `amazon` | AGAIN****** (6)
...
716| [Max Stack](https://leetcode.com/problems/max-stack/) | [C++](./C++/max-stack.cpp) [Python](./leetcode_python/Design/max-stack.py) | push: _O(logn)_<br> pop: _O(logn)_<br> popMax: _O(logn)_<br> top: _O(1)_<br> peekMax: _O(1)_ | _O(n)_ | Easy || 
