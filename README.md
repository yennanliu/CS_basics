...
128| [Longest Consecutive Sequence](https://leetcode.com/problems/longest-consecutive-sequence/)   | [Python](./leetcode_python/Depth-First-Search/longest-consecutive-sequence.py) ||  | Blind Top 75 LC pattern | 
...
784| [Letter Case Permutation](https://leetcode.com/problems/letter-case-permutation/)    | [Python](./leetcode_python/Backtracking/letter-case-permutation.py)  | _O(n * 2^n)_ | _O(1)_ | Easy, `good trick` |`fb`| AGAIN****** (2)
