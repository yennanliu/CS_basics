...
1047| [Remove All Adjacent Duplicates in String](https://leetcode.com/problems/remove-all-adjacent-duplicates-in-string/) |  [python](./leetcode_python/Stack/remove-all-adjacent-duplicates-in-string.py)  | _O(n)_| _O(n)_| easy| good basic, fb, amamzon, google| AGAIN************ (1) (MUST)
