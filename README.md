...
080 | [Remove Duplicates from Sorted Array II](https://leetcode.com/problems/remove-duplicates-from-sorted-array-ii/)|  [Python](./leetcode_python/Array/remove-duplicates-from-sorted-array-ii.py)  | _O(n)_ | _O(1)_ | Medium  |`two pointers`,AGAIN, `basic`, `trick`, `fb`, `#26 Remove Duplicates from Sorted Array`| AGAIN************ (6)
...
224| [Basic Calculator](https://leetcode.com/problems/basic-calculator/) |[python](./leetcode_python/Stack/basic-calculator.py)| _O(n)_| _O(n)_| Hard |`basic`,`trick`,`stack`, check LC 227| AGAIN*** (2)
227| [Basic Calculator II](https://leetcode.com/problems/basic-calculator-ii/) |[python](./leetcode_python/Stack/basic-calculator-ii.py)| _O(n)_| _O(n)_| Medium |check LC 224, `good trick`,`stack`,`airbnb` ,`fb`| AGAIN********** (4)
...
|  #  | Title           |  Solution       |  Time           | Space           | Difficulty    | Tag, Note       | Status| 
|-----|---------------- | --------------- | --------------- | --------------- | ------------- |--------------|-----|
017| [Letter Combinations of a Phone Number](https://leetcode.com/problems/letter-combinations-of-a-phone-number/)| [Python](./leetcode_python/Backtracking/letter-combinations-of-a-phone-number.py)  | _O(n * 4^n)_ | _O(n)_ | Medium |dfs, backtrack, `good trick`,`UBER`, `amazon`, `google`, `fb`| AGAIN************* (9) (again !)
...
926| [Flip String to Monotone Increasing](https://leetcode.com/problems/flip-string-to-monotone-increasing/) | [Python](./leetcode_python/Dynamic_Programming/flip-string-to-monotone-increasing.py) | _O(n)_ | _O(1)_ | Medium |good trick, dp, prefix sum, `google`, `amazon`| AGAIN******** (3)
