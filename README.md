...
1670| [Design Front Middle Back Queue](https://leetcode.com/problems/design-front-middle-back-queue/) | [Python](./Python/Design/design-front-middle-back-queue.py) | _O(k)_ | _O(k)_ | Medium | good basic, Design, `amazon`| AGAIN** (1) (not start)
