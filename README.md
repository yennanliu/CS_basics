...
663 | [Equal Tree Partition](https://leetcode.com/problems/equal-tree-partition/) | [python](./leetcode_python/Tree/equal-tree-partition.py) | _O(n)_ | _O(n)_ | Medium |AGAIN, 🔒 , Hash, tree, dfs ,`trick`, `good trick`, `amazon`| AGAIN******** (5) 
