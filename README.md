...
101| [Symmetric Tree](https://leetcode.com/problems/symmetric-tree/)| [Python](./leetcode_python/Stack/symmetric-tree.py) | _O(n)_ | _O(h)_ | Easy |`good basic`,`bfs`, `dfs`, `linkedin`, `M$`,`amazon`, `fb`, google| AGAIN********** (4) 
150| [Evaluate Reverse Polish Notation](https://leetcode.com/problems/evaluate-reverse-polish-notation/)|  [Python](./leetcode_python/Stack/evaluate-reverse-polish-notation.py) | _O(n)_| _O(n)_| Medium |stack, good trick,`amazon`| AGAIN******* (4)
155| [Min Stack](https://leetcode.com/problems/min-stack/)     | [Python](./leetcode_python/Stack/min-stack.py)  | _O(n)_ | _O(1)_  | Easy |basic, stack, data structure, `amazon`| OK******* (4)
