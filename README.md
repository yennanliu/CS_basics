...
435 | [Non-overlapping Intervals](https://leetcode.com/problems/non-overlapping-intervals/) | [Python](./leetcode_python/Greedy/non-overlapping-intervals.py)  | _O(nlogn)_ | _O(1)_ | Medium | good trick, 2 pointers, inverval, similiar as `#452 Minimum Number of Arrows to Burst Balloons`, Line Sweep, `google` |  AGAIN********* (5)
