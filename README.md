...
|  #  | Title           |  Solution       |  Time           | Space           | Difficulty    | Tag, Note       | Status| 
|-----|---------------- | --------------- | --------------- | --------------- | ------------- |--------------|-----|
017| [Letter Combinations of a Phone Number](https://leetcode.com/problems/letter-combinations-of-a-phone-number/)| [Python](./leetcode_python/Backtracking/letter-combinations-of-a-phone-number.py)  | _O(n * 4^n)_ | _O(n)_ | Medium |dfs, backtrack, `good trick`,`UBER`, `amazon`, `google`, `fb`| AGAIN********** (5) (again !)
...
039| [Combination Sum](https://leetcode.com/problems/combination-sum/)| [Python](./leetcode_python/Backtracking/combination-sum.py) | _O(k * n^k)_ | _O(k)_ | Medium |backtrack,`dfs`,`good basic`,`UBER`, `airbnb`, `amazon`,`fb`| OK****** (4) (but again)
