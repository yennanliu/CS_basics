...
077| [Combinations](https://leetcode.com/problems/combinations/)  | [Python](./leetcode_python/Backtracking/combinations.py) | _O(O(k * C(n, k)))_ | _O(k)_    | Medium     |good trick, backtrack| AGAIN******** (3) (not start)
