...
227| [Basic Calculator II](https://leetcode.com/problems/basic-calculator-ii/) |[python](./leetcode_python/Stack/basic-calculator-ii.py)| _O(n)_| _O(n)_| Medium |`basic`,`trick`,`stack`,`airbnb` ,`fb`| AGAIN********** (4)
