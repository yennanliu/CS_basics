...
257| [Binary Tree Paths](https://leetcode.com/problems/binary-tree-paths/) | [Python](./leetcode_python/Depth-First-Search/binary-tree-paths.py)  | _O(n * h)_ | _O(h)_ | Easy | good basic,`apple`, `google`, `amazon`, `fb`, bfs, dfs, bst| AGAIN********* (6)
