...
538 | [Convert BST to Greater Tree](https://leetcode.com/problems/convert-bst-to-greater-tree/) |  [python](./leetcode_python/Tree/convert-bst-to-greater-tree.py) | _O(n)_ | _O(h)_ | Medium |good basic, dfs, bfs, tree, `amazon`| OK********* (5) (but again!) 
...
089| [Gray Code](https://leetcode.com/problems/gray-code/)     | [Python](./leetcode_python/Math/gray-code.py) | _O(2^n)_ | _O(1)_  | Medium |bit op, math, `amazon`| OK *** (3) (again)
