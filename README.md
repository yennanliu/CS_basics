...
236 | [Lowest Common Ancestor of a Binary Tree](https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-tree/) | [Python](./leetcode_python/Depth-First-Search/lowest-common-ancestor-of-a-binary-tree.py) | _O(n)_ | _O(h)_ | Medium | `trick`,EPI, `LCA`,check `235 Lowest Common Ancestor of a Binary Search Tree`,`apple`,`amazon`,`linkedin`,`fb` | AGAIN*********** (6)
