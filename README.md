...
078| [Subsets](https://leetcode.com/problems/subsets/) | [Python](./leetcode_python/Backtracking/subsets.py) | _O(n * 2^n)_   | _O(1)_| Medium  |`good concept` , similar as, dfs, back track, `#90 Subsets II `, `UBER`, `amazon`, `fb`| AGAIN************ (6) (MUST again!!!)
