...
538 | [Convert BST to Greater Tree](https://leetcode.com/problems/convert-bst-to-greater-tree/) |  [Python](./leetcode_python/Tree/convert-bst-to-greater-tree.py), [Java](./leetcode_java/Tree/ConvertBstToGreaterTree.java) | _O(n)_ | _O(h)_ | Medium |good basic, dfs, bfs, tree, `amazon`| OK********* (6) (but again!) 
