...
617 |[Merge Two Binary Trees](https://leetcode.com/problems/merge-two-binary-trees/)|[Python](./leetcode_python/Tree/merge-two-binary-trees.py), [Java](./leetcode_java/src/main/java/LeetCodeJava/Tree/MergeTwoBinaryTrees.java) | _O(n)_ | _O(h)_ | Easy | tree, dfs, bfs, `good basic`, `amazon`| OK************* (5) (but again)
