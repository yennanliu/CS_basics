...
406| [Queue Reconstruction by Height](https://leetcode.com/problems/queue-reconstruction-by-height/) |  [Python](https://github.com/yennanliu/CS_basics/blob/master/leetcode_python/Sort/queue-reconstruction-by-heigh.py) | _O(n * sqrt(n))_ | _O(n)_        | Medium      |  Tricky | AGAIN (not start)
