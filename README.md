...
143| [Reorder List](https://leetcode.com/problems/reorder-list/)| [Python](./leetcode_python/Two_Pointers/reorder-list.py)| _O(n)_ |  _O(1)_   | Medium  |LC 021, 206, 876, `good trick`,`inverse linkedlist`, `merge linkedlist` ,`fb`|  AGAIN**** (4)
