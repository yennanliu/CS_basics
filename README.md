...
523| [Continuous Subarray Sum](https://leetcode.com/problems/continuous-subarray-sum/) | [Python ](./leetcode_python/Hash_table/continuous-subarray-sum.py) | _O(n)_  | _O(k)_ | Medium |sub array sum, check `# 560 Subarray Sum Equals K`,`good trick`,`substring`, `hash table`,`AGAIN`,`M$`,`fb`| AGAIN************** (7) (MUST)
...
725 | [Split Linked List in Parts](https://leetcode.com/problems/split-linked-list-in-parts/) | [Python](./leetcode_python/Linked_list/split-linked-list-in-parts.py)  | _O(n + k)_ | _O(1)_ | Medium |mod, split linked list, linked list, good trick,`amazon`| AGAIN********* (4) (again)
...
663 | [Equal Tree Partition](https://leetcode.com/problems/equal-tree-partition/) | [python](./leetcode_python/Tree/equal-tree-partition.py) | _O(n)_ | _O(n)_ | Medium |`# LC 508`, AGAIN, 🔒 , Hash, tree, dfs ,`trick`, `good trick`, `amazon`| AGAIN******** (6) 
...
468| [Validate IP Address](https://leetcode.com/problems/validate-ip-address/) | [python](./leetcode_python/String/validate-ip-address.py) | _O(1)_ | _O(1)_ | Medium  | `ip basic`,`string`,`twitter`, `fb`| AGAIN****** (5)
...
077| [Combinations](https://leetcode.com/problems/combinations/)  | [Python](./leetcode_python/Backtracking/combinations.py) | _O(O(k * C(n, k)))_ | _O(k)_    | Medium     |backtrack| AGAIN*** (2) (not start)
...
588| [Design In-Memory File System](https://leetcode.com/problems/design-in-memory-file-system/) | [C++](./C++/design-in-memory-file-system.cpp) [Python](./leetcode_python/Design/design-in-memory-file-system.py) | ls: _O(l + klogk)_<br> mkdir: _O(l)_<br> addContentToFile: _O(l + c)_<br> readContentFromFile: _O(l + c)_ | _O(n + s)_ | Hard |🔒| |
...
1500| [Design a File Sharing System](https://leetcode.com/problems/design-a-file-sharing-system/) [Python](./eetcode_python/Design/design-a-file-sharing-system.py) | _O(k)_ | _O(k)_ | Medium |design, hashmap | AGAIN*** (not start)
