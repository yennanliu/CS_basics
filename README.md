...
067| [Add Binary](https://leetcode.com/problems/add-binary/)    | [python](./leetcode_python/String/add-binary.py)  | _O(n)_  | _O(1)_   | Easy   | bit op, `good basic`, `fb`, `amazon`| OK***** (6) (but again)
