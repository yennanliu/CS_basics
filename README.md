...
538 | [Convert BST to Greater Tree](https://leetcode.com/problems/convert-bst-to-greater-tree/) |  [python](./leetcode_python/Tree/convert-bst-to-greater-tree.py) | _O(n)_ | _O(h)_ | Medium |good basic, dfs, bfs, tree, `amazon`| OK***** (3) (but again!) 
