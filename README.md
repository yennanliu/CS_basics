...
2021| [Brightest Position on Street](https://leetcode.com/problems/brightest-position-on-street/) | [Python](./leetcode_python/Sort/brightest-position-on-street.py) | _O(nlogn)_ | _O(1)_  | Medium | LC 253 meeting room II, priority queue (min-heap),scanning line, trick, `amazon`| AGAIN*** (1) (not start)
...
449|[Serialize and Deserialize BST](https://leetcode.com/problems/serialize-and-deserialize-bst/)| [python](./leetcode_python/Binary_Search_Tree/serialize-and-deserialize-bst.py) | _O(n)_ | _O(h)_ | Medium |good trick,`serizlize deserizlize`,`BST`, tree,check #297, `amazon`, `fb`| AGAIN************* (8)
...
207| [Course Schedule](https://leetcode.com/problems/course-schedule/)| [Python](./leetcode_python/Breadth-First-Search/course-schedule.py)  | _O(\|V\| + \|E\|)_   |  _O(\|E\|)_  |  Medium  |Topological Sort, backtrack, `good trick`,`dfs`, `bfs` , `amazon`,`fb`| AGAIN************** (9) (MUST) 
...
1972 | [First and Last Call On the Same Day](https://leetcode.com/problems/first-and-last-call-on-the-same-day/) | [MySQL](./leetcode_SQL/first-and-last-call-on-the-same-day.sql) | _O(n)_ | _O(n)_| Hard|🔒, rank, union all| AGAIN** (2)
