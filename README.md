...
404| [Sum of Left Leaves](https://leetcode.com/problems/sum-of-left-leaves/) | [Python](./leetcode_python/Recursion/sum-of-left-leaves.py), [Java](./leetcode_java/src/main/java/LeetCodeJava/Recursion/SumOfLeftLeaves.java)  | _O(n)_ | _O(h)_ | Easy, tree, bfs, dfs, amazon|`fb`| AGAIN**** (4) 
