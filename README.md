...
921| [Sort an Array](https://leetcode.com/problems/sort-an-array/) | [Python](./leetcode_python/Sort/sort_an_array.py) | _O(nlogn)_ | _O(1)_  | Medium | sort, merge sort, quick sort, apple, amazon, m$| AGAIN** (1)
...
084| [Largest Rectangle in Histogram](https://leetcode.com/problems/largest-rectangle-in-histogram/)     |[Python](./leetcode_python/Greedy/largest-rectangle-in-histogram.py)  | _O(n)_ | _O(1)_| Hard|top 100 like, 2 pointers, brute force, divide and conquer, stack, LC 085, amazon, fb| AGAIN (not start)
