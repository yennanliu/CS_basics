...
547| [Number of Provinces](https://leetcode.com/problems/number-of-provinces/) | [Python](./leetcode_python/Depth-First-Search/number-of-provinces.py)  | _O(n^2)_  | _O(n)_ | Medium |dfs, bfs, graph, union find, good basic, apple, amazon| AGAIN********* (1) (MUST)
