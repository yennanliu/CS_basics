...
|-----|---------------- | --------------- | --------------- | --------------- | ------------- |--------------|-----|
005| [Longest Palindromic Substring](https://leetcode.com/problems/longest-palindromic-substring/) | [python](./leetcode_python/String/longest-palindromic-substring.py)  | _O(n)_ | _O(n)_ |  Medium | good trick, 2 pointer, `Manacher's Algorithm`, LC 100 like, `DP`, `UBER`, `amazon`, `fb` | AGAIN************ (7)(MUST)
