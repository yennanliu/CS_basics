...
022| [Generate Parentheses](https://leetcode.com/problems/generate-parentheses/)| [Python](./leetcode_python/Backtracking/generate-parentheses.py) | _O(4^n / n^(3/2))_ | _O(n)_   | Medium  |LC 20, good basic, DFS, backtracking,`amazon`| OK********** (3) (but again, MUST)
