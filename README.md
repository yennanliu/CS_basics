...
|-----|---------------- | --------------- | --------------- | --------------- | ------------- |--------------|-----|
005| [Longest Palindromic Substring](https://leetcode.com/problems/longest-palindromic-substring/) | [python](./leetcode_python/String/longest-palindromic-substring.py)  | _O(n)_ | _O(n)_ |  Medium | good trick, 2 pointer, recursive, `Manacher's Algorithm`, LC 100 like, `DP`, `UBER`, `amazon`, `fb` | AGAIN************ (7)(MUST)
...
791| [Custom Sort String](https://leetcode.com/problems/custom-sort-string/) | [python](./leetcode_python/String/custom-sort-string.py) | _O(n)_ | _O(1)_ | Medium |`good basic`, counter, `amazon`, `fb`| AGAIN********** (6) 
