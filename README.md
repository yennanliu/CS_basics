...
670| [Maximum Swap](https://leetcode.com/problems/maximum-swap/) | [Python](./leetcode_python/Array/maximum-swap.py)| _O(logn)_ |  _O(logn)_ | Medium |`good basic`, AGAIN, reversed, str -> list,string + pointers , `fb`| AGAIN******* (5)
...
406| [Queue Reconstruction by Height](https://leetcode.com/problems/queue-reconstruction-by-height/) |  [Python](./leetcode_python/Sort/queue-reconstruction-by-height.py) | _O(n * sqrt(n))_ | _O(n)_ | Medium  | `basic`,`trick`, `sort by key`, `insert`, `google` | AGAIN********* (4)
...
257| [Binary Tree Paths](https://leetcode.com/problems/binary-tree-paths/) | [Python](./leetcode_python/Depth-First-Search/binary-tree-paths.py)  | _O(n * h)_ | _O(h)_ | Easy |good basic,`apple`, `google`, `amazon`, `fb`| AGAIN******* (5)
