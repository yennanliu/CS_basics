...
024| [Swap Nodes in Pairs](https://leetcode.com/problems/swap-nodes-in-pairs/)| [Python](./leetcode_python/Linked_list/swap-nodes-in-pairs.py)  | _O(n)_ | _O(1)_ | Medium  |`GOOD basic`, LC 100 like, `UBER`,`amazon`, `fb`| AGAIN************* (5) (MUST)
