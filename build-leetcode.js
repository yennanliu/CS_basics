...
// Generate simple LC Explorer page
function generateSimpleLcExplorer() {
  return `<!DOCTYPE html>
<html lang="en" data-theme="light">
<head>
  <meta charset="UTF-8">
...
try {
  ...
  // Generate simple LC explorer (new approach)
  console.log('Generating simple LC Explorer page...');
  const simpleLcExplorer = generateSimpleLcExplorer();
  console.log('Writing _site/lc-explorer.html...');
  fs.writeFileSync('_site/lc-explorer.html', simpleLcExplorer);
  console.log('✓ Created _site/lc-explorer.html');

  // Generate legacy pages if needed
  console.log('Generating legacy HTML page...');
