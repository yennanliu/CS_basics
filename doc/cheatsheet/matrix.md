...
> **See also**: [matrix_examples.md](./matrix_examples.md) — the seventeen worked problems behind these templates; [dfs.md](./dfs.md) and [bfs.md](./bfs.md) — grid search; [array.md](./array.md) — the 1D operations these build on; [prefix_sum.md](./prefix_sum.md) — 2D range sums; [dp.md](./dp.md) — grid DP.
...
Seventeen problems live in **[matrix_examples.md](./matrix_examples.md)**, grouped by the
geometry or technique each one turns on:

| Group | Problems |
|---|---|
| [Traversal & diagonals](./matrix_examples.md#traversal--diagonals) | LC 54, 498, 1329 |
| [Transformation & in-place modification](./matrix_examples.md#transformation--in-place-modification) | LC 48, 289, 73, 661 |
| [Search](./matrix_examples.md#search) | LC 74, 240, 378 |
| [DFS / BFS on a grid](./matrix_examples.md#dfs--bfs-on-a-grid) | LC 200, 329 |
| [2D dynamic programming](./matrix_examples.md#2d-dynamic-programming) | LC 64, 221, 85 |
| [Prefix sums & row-pair compression](./matrix_examples.md#prefix-sums--row-pair-compression) | LC 1314, 1074 |
