...
| I want to… | Go to |
|---|---|
| know what a built-in costs — `len`, `max`, `in`, `+`, `split`, slicing, `dict`/`set` ops | [python_complexity.md](./python_complexity.md) |
