...
> The 12 templates above are Python-first. The 12 below are the same problem space written
...
| Template 4: Interval Scheduling | 12. Two Heaps as Resource Pools | LC 253 |
...
| Template 9: PQ + Sweep Line (lazy delete) | 8. Lazy Deletion / 9. Sweep Line + Max Heap | LC 218 |
| Template 10: Greedy with Regret | 11. Bounded "Regret" Heap | LC 871 |
| Template 11: Sort + Fixed-Size Heap | 7. Frequency Uniqueness Template | LC 857 |
| Template 12: Min-Heap Best-First on a Grid | 6. Grid Shortest Path with Range Jumps | LC 407 |
...
| 373 / 378 | K Pairs with Smallest Sums / Kth Smallest in Sorted Matrix | Lists are **virtual** rows of a sorted grid — see `2-10` / `2-11` under LC Example |
...
### Java-first examples (merged from `priority_queue.md`)
...
### Flowchart view (merged from `priority_queue.md`)
