...
strings representing survey responses from the ith day.
...
Input: responses = [["good","ok","good"],["ok","bad"],["bad","notsure"],["question","ok"]]
Output: "ok"
Explanation:
After removing duplicates within each list we have responses = [["good", "ok"],
["ok", "bad"], ["bad", "notsure"], ["question", "ok"]].
"bad", "good", and "ok" have a frequency of 2, 1, and 3 respectively.
Return "ok" because it has the highest frequency.
