...
consecutive in the alphabet, in either order (e.g., 'a' and 'b', or 'b' and 'a').
...
Output: "c"
Explanation:
Remove "ab" from the string, leaving "c" as the result.
...
Output: ""
Explanation:
Remove "dc" from the string, leaving "ab" as the result, then remove "ab",
...
Output: "db"
Explanation:
Remove "za" from the string, leaving "db" as the result.
