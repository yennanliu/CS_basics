...
Select subarray [1,1], then [3,3], then [5,5]; each clears one remaining 2. Note
that the three 2's cannot be cleared together, because any subarray containing
two of them also contains a 0, which would be the minimum instead.
