...
# IDEA : GREEDY + SORTING
#
#   Take the largest element first: this maximises the sum for any given size,
#   so the first time the taken sum beats the remaining sum we have both the
#   minimum size AND the maximum sum. The list is already non-increasing.
#
# time = O(n log n)
# space = O(n)
