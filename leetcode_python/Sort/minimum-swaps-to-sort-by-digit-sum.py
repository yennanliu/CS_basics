...
-> [4, 5, 6, 7]
Sort the integers based on digit sum: [22, 14, 33, 7]. The array is already in
sorted order.
...
Output: 2
Explanation:
Compute the digit sum for each integer: [1 + 8 = 9, 4 + 3 = 7, 3 + 4 = 7,
1 + 6 = 7] -> [9, 7, 7, 7]
Sort the integers based on digit sum: [16, 34, 43, 18]. Swap 18 with 16, and swap
43 with 34 to obtain the sorted order.
