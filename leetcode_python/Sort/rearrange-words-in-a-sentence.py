...
Your task is to rearrange the words in text such that all words are rearranged in
an increasing order of their lengths. If two words have the same length, arrange
...
#
#  - python's sort IS stable -> equal-length words keep their original order
#  - lower-case the (originally capitalised) 1st word before sorting,
#    then capitalise whichever word ends up first
#
# time = O(n log n)
# space = O(n)
