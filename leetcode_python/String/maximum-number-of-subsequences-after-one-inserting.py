...
Output: 2
Explanation:
We can insert a "L" at the beginning of the string to have "LLMCT", which has 2 subsequences that equal "LCT".
...
Output: 4
Explanation:
We can insert a "L" at the beginning of the string to have "LLCCT", which has 4 subsequences that equal "LCT".
...
Output: 0
Explanation:
Since it is not possible to obtain the subsequence "LCT" by inserting a single character, the result is 0.
