...
# V0
# IDEA : MATH (Chebyshev distance)
#        a diagonal step changes BOTH coordinates by 1, so the cost between
#        two points is max(|dx|, |dy|) : move diagonally min(|dx|,|dy|) times,
#        then straight for the leftover
# time = O(n)
# space = O(1)
