...
web page's area, your job by now is to design a rectangular web page, whose length L and width W
...
#        -> the 1st divisor found is the biggest W with W <= L, so |L - W| is minimal
# time = O(sqrt(area))
# space = O(1)
import math
